...
const VIDEOS = [
  ...
  'media/videos/typowy_miejscowi.mp4'
]

const FILE_DOWNLOADS = [
  'media/images/fan_szreka.jpg',
  'media/images/głodomor.jpg',
  'media/images/intro.jpg',
  'media/images/lustro.jpg',
  'media/images/ogórek.jpg',
  'media/images/pudło.jpg',
]

const PHRASES = [
  'hello my name is pudło, lol',
  'pudło',
  'toster',
  'instagram',
]
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'PudłoChuj')
  })
}
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'pudło@toster.pl',
          displayName: 'PudłoNaMieście'
        },
