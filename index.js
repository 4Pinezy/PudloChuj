...
const VIDEOS = [
  'media/videos/alternative.mov',
  'media/videos/blackfriday.mov',
  'media/videos/dance.mp4',
  'media/videos/dj_oskar.mov',
...
const FILE_DOWNLOADS = [
  'media/images/fotka.png',
  'media/images/glodomor.jpg',
  'media/images/impreza.png',
  'media/images/intro.jpg',
  'media/images/nalesnik.jpg',
  'media/images/nosaty.jpg',
  'media/images/placek.jpg',
  'media/images/pudlo.jpg',
  'media/images/shrek.jpg',
  'media/images/spioszek.jpg',
  'media/images/swag.png',
  'media/images/zabawne.jpg',
]
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'pudlochuj@wodoglowie.pl',
          displayName: 'Oskaruska123'
        },
...
function copySpamToClipboard () {
  const randomArt = getRandomArrayEntry(ART) + '\nSprawdz https://4pinezy.github.io/PudloChuj'
